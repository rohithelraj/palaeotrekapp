...
@Component({
  selector: 'jhi-xdna-temperature',
  templateUrl: './xdna-temperature.component.html',
  styleUrls: ['./xdna-temperature.component.scss']
})
export class XdnaTemperatureComponent implements OnInit {
  public src: Blob;
  ...
  ngOnInit(): void {
    this.accountService.identity().subscribe(account => {
      if (account) {
        ...
        const pdfId = id+"_Xdna_Temperature";
