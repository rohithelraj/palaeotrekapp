...
export class PdfDataComponent implements OnInit {
  ...
  delete(pdfData: IPdfData): void {
    const modalRef = this.modalService.open(PdfDataDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IPdfData[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
