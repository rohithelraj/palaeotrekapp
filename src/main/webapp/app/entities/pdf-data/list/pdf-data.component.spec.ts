...
describe('PdfData Management Component', () => {
  let comp: PdfDataComponent;
  let fixture: ComponentFixture<PdfDataComponent>;
  let service: PdfDataService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pdf-data', component: PdfDataComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PdfDataComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pdfData?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
