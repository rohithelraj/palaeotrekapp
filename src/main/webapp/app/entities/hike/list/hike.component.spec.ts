...
describe('Hike Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'hike', component: HikeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.hikes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
