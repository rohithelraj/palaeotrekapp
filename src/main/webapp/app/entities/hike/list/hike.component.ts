...
export class HikeComponent implements OnInit {
  ...
  trackId(_index: number, item: IHike): number {
    return item.id!;
  }
  ...
  delete(hike: IHike): void {
    const modalRef = this.modalService.open(HikeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IHike[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
