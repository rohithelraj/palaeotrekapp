...
@Component({
  selector: 'jhi-autosomal-temperature',
  templateUrl: './autosomal-temperature.component.html',
  styleUrls: ['./autosomal-temperature.component.scss']
})
export class AutosomalTemperatureComponent implements OnInit {
  public src: Blob;
  ...
  ngOnInit(): void {
    this.accountService.identity().subscribe(account => {
      if (account) {
        ...
        const pdfId = id+"_Autosomal_Temperature";
