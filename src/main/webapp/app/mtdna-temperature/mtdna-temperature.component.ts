...
@Component({
  selector: 'jhi-mtdna-temperature',
  templateUrl: './mtdna-temperature.component.html',
  styleUrls: ['./mtdna-temperature.component.scss']
})
export class MtdnaTemperatureComponent implements OnInit {
  public src: Blob;
  ...
  ngOnInit(): void {
    this.accountService.identity().subscribe(account => {
      if (account) {
        ...
        const pdfId = id+"_mtdna_Temperature";
