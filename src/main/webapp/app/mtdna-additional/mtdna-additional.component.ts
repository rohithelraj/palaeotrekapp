...
@Component({
  selector: 'jhi-mtdna-additional',
  templateUrl: './mtdna-additional.component.html',
  styleUrls: ['./mtdna-additional.component.scss']
})
export class MtdnaAdditionalComponent implements OnInit {
  public src: Blob;
