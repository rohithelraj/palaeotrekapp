...
@Component({
  selector: 'jhi-autosomal-additional',
  templateUrl: './autosomal-additional.component.html',
  styleUrls: ['./autosomal-additional.component.scss']
})
export class AutosomalAdditionalComponent implements OnInit {
public src: Blob;
  ...
  ngOnInit(): void {
    this.accountService.identity().subscribe(account => {
      if (account) {
        ...
        const pdfId = id+"_Autosomal_Additional";
