...
@Component({
  selector: 'jhi-xdna-maps',
  templateUrl: './xdna-maps.component.html',
  styleUrls: ['./xdna-maps.component.scss']
})
export class XdnaMapsComponent implements OnInit {
  public src: Blob;
