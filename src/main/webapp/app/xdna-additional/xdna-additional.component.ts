...
@Component({
  selector: 'jhi-xdna-additional',
  templateUrl: './xdna-additional.component.html',
  styleUrls: ['./xdna-additional.component.scss']
})
export class XdnaAdditionalComponent implements OnInit {
  public src: Blob;
