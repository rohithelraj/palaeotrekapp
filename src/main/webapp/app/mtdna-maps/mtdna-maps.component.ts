...
@Component({
  selector: 'jhi-mtdna-maps',
  templateUrl: './mtdna-maps.component.html',
  styleUrls: ['./mtdna-maps.component.scss']
})
export class MtdnaMapsComponent implements OnInit {
  public src: Blob;
