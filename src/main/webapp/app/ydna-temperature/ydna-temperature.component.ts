...
@Component({
  selector: 'jhi-ydna-temperature',
  templateUrl: './ydna-temperature.component.html',
  styleUrls: ['./ydna-temperature.component.scss']
})
export class YdnaTemperatureComponent implements OnInit {
  public src: Blob;
  ...
  ngOnInit(): void {
    this.accountService.identity().subscribe(account => {
      if (account) {
        ...
        const pdfId = id+"_Ydna_Temperature";
